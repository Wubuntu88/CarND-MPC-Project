    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // fits lists of xses and ys into third order polynomial
          ...
          */
          ...
          // makes a sequence of 'num_points' of length 'poly_inc' and
          // that will show the line of the trajectory of the car
